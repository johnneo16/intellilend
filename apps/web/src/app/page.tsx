...
import {
  IndianRupee, FileText, Brain, AlertTriangle,
  Clock, CheckCircle2, TrendingUp, Activity,
} from 'lucide-react'

const KPI_DATA = [
  {
    title: 'Total Disbursed (Mar)',
    value: '₹7.1 Cr',
    change: 24.6,
    changeLabel: 'vs ₹5.7Cr last month',
    icon: <IndianRupee className="w-5 h-5" />,
    accentColor: '#6366f1',
    sparkline: [42, 51, 48, 62, 57, 71],
    delay: 0,
  },
  {
    ...
    value: '241',
    change: 27.5,
    changeLabel: 'vs 189 last month',
    icon: <FileText className="w-5 h-5" />,
    accentColor: '#f59e0b',
    sparkline: [142, 165, 158, 203, 189, 241],
    delay: 75,
  },
  {
    ...
    value: '38',
    change: 8.6,
    changeLabel: '4 flagged for manual review',
    icon: <Brain className="w-5 h-5" />,
    accentColor: '#8b5cf6',
    sparkline: [28, 35, 31, 42, 35, 38],
    delay: 150,
  },
  {
    title: 'NPA Rate',
    value: '1.7%',
    change: -18.1,
    changeLabel: 'Down from 2.1% in October',
    icon: <AlertTriangle className="w-5 h-5" />,
    accentColor: '#10b981',
    sparkline: [21, 23, 20, 19, 22, 17],
    delay: 225,
  },
]
...
export default function DashboardPage() {
  return (
    <div className="flex flex-col h-full overflow-auto scrollbar-thin bg-[#080b14]">
      <Header
        title="Dashboard"
        subtitle="Mumbai HQ · March 2024"
      ...
      <div className="flex-1 p-5 space-y-5">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-3">
          {PIPELINE_STATS.map(({ label, value, icon: Icon, color }) => (
            <div
              key={label}
              className="glass-card-hover rounded-xl px-4 py-3.5 flex items-center gap-3"
              style={{
