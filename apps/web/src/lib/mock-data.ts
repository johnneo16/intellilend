...
export const ALL_APPLICATIONS: LoanApplication[] = [
  {
    ...
    applicant: { id: 'a1', name: 'Priya Sharma', email: 'priya@example.com', phone: '+91-98765-00000', panNumber: 'ABCPS1234D', dateOfBirth: '1988-03-15', employmentType: 'SALARIED', monthlyIncome: 85000, creditScore: 758 },
  ...
  },
  {
    ...
    applicant: { id: 'a2', name: 'Rahul Verma', email: 'rahul@example.com', phone: '+91-87654-00000', panNumber: 'ABCRV5678E', dateOfBirth: '1985-07-22', employmentType: 'SELF_EMPLOYED', monthlyIncome: 120000, creditScore: 692 },
  ...
  },
  {
    ...
    applicant: { id: 'a3', name: 'Anjali Patel', email: 'anjali@example.com', phone: '+91-76543-00000', panNumber: 'ABCAP9012F', dateOfBirth: '1992-11-08', employmentType: 'SALARIED', monthlyIncome: 65000, creditScore: 801 },
  ...
  },
  {
    ...
    applicant: { id: 'a4', name: 'Vikram Singh', email: 'vikram@example.com', phone: '+91-65432-00000', panNumber: 'ABCVS3456G', dateOfBirth: '1979-05-14', employmentType: 'BUSINESS', monthlyIncome: 200000, creditScore: 634 },
  ...
  },
  {
    ...
    applicant: { id: 'a5', name: 'Meera Krishnan', email: 'meera@example.com', phone: '+91-54321-00000', panNumber: 'ABCMK7890H', dateOfBirth: '1990-09-30', employmentType: 'SALARIED', monthlyIncome: 95000, creditScore: 775 },
  ...
  {
    id: '6', applicationNumber: 'ILL-2024-001242',
    applicant: { id: 'a6', name: 'Sunita Rao', email: 'sunita@example.com', phone: '+91-93456-00000', panNumber: 'ABCSR2345I', dateOfBirth: '1983-06-12', employmentType: 'SALARIED', monthlyIncome: 110000, creditScore: 812 },
  ...
  {
    id: '7', applicationNumber: 'ILL-2024-001241',
    applicant: { id: 'a7', name: 'Ramesh Nair', email: 'ramesh@example.com', phone: '+91-82345-00000', panNumber: 'ABCRN4567J', dateOfBirth: '1971-02-28', employmentType: 'SELF_EMPLOYED', monthlyIncome: 75000, creditScore: 711 },
  ...
  {
    id: '8', applicationNumber: 'ILL-2024-001240',
    applicant: { id: 'a8', name: 'Fatima Sheikh', email: 'fatima@example.com', phone: '+91-71234-00000', panNumber: 'ABCFS6789K', dateOfBirth: '1995-08-19', employmentType: 'SALARIED', monthlyIncome: 55000, creditScore: 648 },
  ...
  {
    id: '9', applicationNumber: 'ILL-2024-001239',
    applicant: { id: 'a9', name: 'Kiran Desai', email: 'kiran@example.com', phone: '+91-60123-00000', panNumber: 'ABCKD8901L', dateOfBirth: '1982-04-05', employmentType: 'BUSINESS', monthlyIncome: 180000, creditScore: 745 },
  ...
  {
    id: '10', applicationNumber: 'ILL-2024-001238',
    applicant: { id: 'a10', name: 'Arjun Mehta', email: 'arjun@example.com', phone: '+91-59012-00000', panNumber: 'ABCAM0123M', dateOfBirth: '1999-01-20', employmentType: 'SALARIED', monthlyIncome: 45000, creditScore: 699 },
  ...
  {
    id: '11', applicationNumber: 'ILL-2024-001237',
    applicant: { id: 'a11', name: 'Deepak Nair', email: 'deepak@example.com', phone: '+91-48901-00000', panNumber: 'ABCDN1234N', dateOfBirth: '1987-12-10', employmentType: 'SALARIED', monthlyIncome: 90000, creditScore: 733 },
  ...
  {
    id: '12', applicationNumber: 'ILL-2024-001236',
    applicant: { id: 'a12', name: 'Neha Gupta', email: 'neha@example.com', phone: '+91-37890-00000', panNumber: 'ABCNG2345O', dateOfBirth: '1991-07-25', employmentType: 'SALARIED', monthlyIncome: 130000, creditScore: 821 },
...
export const CUSTOMERS = [
  { id: 'c1', name: 'Priya Sharma',   email: 'priya@example.com',  phone: '+91-98765-00000', creditScore: 758, totalLoans: 1, activeLoans: 1, totalBorrowed: 4500000, outstanding: 4200000, status: 'ACTIVE',   joined: '2024-03-20', riskTag: 'LOW' },
  { id: 'c2', name: 'Rahul Verma',    email: 'rahul@example.com',  phone: '+91-87654-00000', creditScore: 692, totalLoans: 1, activeLoans: 1, totalBorrowed: 2500000, outstanding: 2350000, status: 'ACTIVE',   joined: '2024-03-20', riskTag: 'MEDIUM' },
  { id: 'c3', name: 'Anjali Patel',   email: 'anjali@example.com', phone: '+91-76543-00000', creditScore: 801, totalLoans: 2, activeLoans: 1, totalBorrowed: 1500000, outstanding: 650000,  status: 'ACTIVE',   joined: '2023-08-15', riskTag: 'LOW' },
  { id: 'c4', name: 'Vikram Singh',   email: 'vikram@example.com', phone: '+91-65432-00000', creditScore: 634, totalLoans: 1, activeLoans: 0, totalBorrowed: 1800000, outstanding: 0,       status: 'PROSPECT', joined: '2024-03-19', riskTag: 'HIGH' },
  { id: 'c5', name: 'Meera Krishnan', email: 'meera@example.com',  phone: '+91-54321-00000', creditScore: 775, totalLoans: 2, activeLoans: 2, totalBorrowed: 2600000, outstanding: 1750000, status: 'ACTIVE',   joined: '2023-06-10', riskTag: 'LOW' },
  { id: 'c6', name: 'Sunita Rao',     email: 'sunita@example.com', phone: '+91-93456-00000', creditScore: 812, totalLoans: 1, activeLoans: 1, totalBorrowed: 6500000, outstanding: 6100000, status: 'ACTIVE',   joined: '2024-03-18', riskTag: 'LOW' },
  { id: 'c7', name: 'Ramesh Nair',    email: 'ramesh@example.com', phone: '+91-82345-00000', creditScore: 711, totalLoans: 3, activeLoans: 1, totalBorrowed: 950000,  outstanding: 180000,  status: 'ACTIVE',   joined: '2022-11-20', riskTag: 'LOW' },
  { id: 'c8', name: 'Fatima Sheikh',  email: 'fatima@example.com', phone: '+91-71234-00000', creditScore: 648, totalLoans: 1, activeLoans: 0, totalBorrowed: 500000,  outstanding: 0,       status: 'INACTIVE', joined: '2024-03-16', riskTag: 'HIGH' },
  { id: 'c9', name: 'Kiran Desai',    email: 'kiran@example.com',  phone: '+91-60123-00000', creditScore: 745, totalLoans: 2, activeLoans: 1, totalBorrowed: 7500000, outstanding: 4800000, status: 'ACTIVE',   joined: '2023-02-28', riskTag: 'MEDIUM' },
  { id: 'c10', name: 'Arjun Mehta',   email: 'arjun@example.com',  phone: '+91-59012-00000', creditScore: 699, totalLoans: 1, activeLoans: 0, totalBorrowed: 2000000, outstanding: 0,       status: 'PROSPECT', joined: '2024-03-20', riskTag: 'MEDIUM' },
  { id: 'c11', name: 'Deepak Nair',   email: 'deepak@example.com', phone: '+91-48901-00000', creditScore: 733, totalLoans: 2, activeLoans: 1, totalBorrowed: 1850000, outstanding: 320000,  status: 'OVERDUE',  joined: '2023-05-01', riskTag: 'MEDIUM' },
  { id: 'c12', name: 'Neha Gupta',    email: 'neha@example.com',   phone: '+91-37890-00000', creditScore: 821, totalLoans: 1, activeLoans: 0, totalBorrowed: 8500000, outstanding: 0,       status: 'PROSPECT', joined: '2024-03-20', riskTag: 'LOW' },
]

/* ── Active loans ───────────────────────────────────────────────────── */
export const ACTIVE_LOANS = [
  { id: 'L001', appId: 'ILL-2024-001243', borrower: 'Meera Krishnan', type: 'EDUCATION', sanctioned: 1200000, outstanding: 1050000, emi: 14200, nextDue: '2024-04-05', daysOverdue: 0, status: 'CURRENT' },
  { id: 'L002', appId: 'ILL-2024-001245', borrower: 'Anjali Patel',   type: 'PERSONAL',  sanctioned: 800000,  outstanding: 650000,  emi: 23800, nextDue: '2024-04-08', daysOverdue: 0, status: 'CURRENT' },
  { id: 'L003', appId: 'ILL-2024-001237', borrower: 'Deepak Nair',    type: 'HOME',      sanctioned: 3500000, outstanding: 3200000, emi: 31500, nextDue: '2024-03-28', daysOverdue: 5, status: 'OVERDUE' },
  { id: 'L004', appId: 'ILL-2024-001233', borrower: 'Sunita Rao',     type: 'AUTO',      sanctioned: 950000,  outstanding: 720000,  emi: 18400, nextDue: '2024-04-10', daysOverdue: 0, status: 'CURRENT' },
  { id: 'L005', appId: 'ILL-2024-001241', borrower: 'Ramesh Nair',    type: 'GOLD',      sanctioned: 350000,  outstanding: 180000,  emi: 15200, nextDue: '2024-04-01', daysOverdue: 0, status: 'CURRENT' },
  { id: 'L006', appId: 'ILL-2024-001246', borrower: 'Rahul Verma',    type: 'BUSINESS',  sanctioned: 2500000, outstanding: 2350000, emi: 48300, nextDue: '2024-03-31', daysOverdue: 0, status: 'CURRENT' },
]
...
export const ACTIVITY_FEED = [
  { id: 1, type: 'approval',    text: 'ILL-2024-001245 approved — Anjali Patel',         sub: 'AI Score 88 · FOIR 31.5%',    time: '2 min ago',  color: '#10b981' },
  { id: 2, type: 'ai',          text: 'AI pipeline completed — ILL-2024-001247',          sub: '4 agents · 5,080 tokens · 7s', time: '5 min ago',  color: '#6366f1' },
  { id: 3, type: 'disbursement',text: 'Disbursement ₹12L — ILL-2024-001243',              sub: 'Meera Krishnan · HDFC Bank',   time: '18 min ago', color: '#3b82f6' },
  { id: 4, type: 'alert',       text: 'Overdue alert — L003 Deepak Nair',               sub: '5 days past due · ₹31,500',    time: '1 hr ago',   color: '#ef4444' },
  { id: 5, type: 'application', text: 'New application — ILL-2024-001236 Neha Gupta',    sub: 'Home Loan ₹85L',               time: '2 hrs ago',  color: '#f59e0b' },
  { id: 6, type: 'rejection',   text: 'ILL-2024-001240 rejected — Fatima Sheikh',        sub: 'FOIR 62.1% — exceeds limit',   time: '4 hrs ago',  color: '#ef4444' },
  { id: 7, type: 'application', text: 'New application — ILL-2024-001239 Kiran Desai',   sub: 'Business Loan ₹50L',           time: '5 hrs ago',  color: '#f59e0b' },
]
...
export const ALERTS = [
  ...
  { id: 'al2', type: 'AI_FLAG',     title: 'AI flagged ILL-2024-001244',      body: 'Vikram Singh (ILL-2024-001244) AI score 54 — below threshold. Manual review required.', time: '2 hrs ago', priority: 'HIGH', read: false },
  { id: 'al3', type: 'RISK',        title: 'FOIR breach — ILL-2024-001240',   body: 'Fatima Sheikh FOIR 62.1% exceeds 55% cap. Application auto-rejected.', time: '4 hrs ago', priority: 'MEDIUM', read: true },
